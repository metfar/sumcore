...
DEFAULT_ARCHITECTURE = {
    "sumCore": {"version":"0.1.0a14", "requires":[], "optional":[], "role":"core architecture and registries"},
    ...
    "sumGUI": {"version":"0.2.0a24", "requires":["sumUI"], "optional":["matplotlib","seaborn"], "role":"Pygame presentation"},
