...
|---|---|---|---|---|
| sumCore | 0.1.0a18 |  |  | core architecture, identity and shared services |
...
| sumTerminal | 0.1.0a2 | sumFSA;sumIO;sumbash;sumGUI;sumKeyboard |  | terminal/session engine, graphical frontend and drop-down host |
...
| sumKeyboard | 0.1.0a2 |  |  | portable keyboard profiles |
